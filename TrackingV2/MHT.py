...
class Track_Tree:
    ...
    def Firm_D2TA(self,track,detections,CNLLR):
        ...
        gate_r_L = track.x_iso[0]-range_resolution*1.5
        gate_r_H = track.x_iso[0]+range_resolution*1.5 
    ...
    def perliminary_D2TA(self,track,detections,t =50*10**(-3),treshold=5):
        ...
        gate_r_L = track.x_iso[0]-range_resolution#
        gate_r_H = track.x_iso[0]+range_resolution 
